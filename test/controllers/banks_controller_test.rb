...
class BanksControllerTest < ActionController::TestCase
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post :create, bank: { balance: @bank.balance, bank_card: @bank.bank_card, bank_name: @bank.bank_name, name: @bank.name }
    end
  ...
  test "should update bank" do
    patch :update, id: @bank, bank: { balance: @bank.balance, bank_card: @bank.bank_card, bank_name: @bank.bank_name, name: @bank.name }
    assert_redirected_to bank_path(assigns(:bank))
  end

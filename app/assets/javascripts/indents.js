$(function() {
  ...
  $("#indent_form_fields").on("nested:fieldAdded", function(e){
    var fields = e.field;
    fields.find(".material-ply").select2({
      language: 'zh-CN',
      theme: 'bootstrap',
      placeholder: "板厚",
      minimumInputLength: 0,
    ...
    fields.find(".material-texture").select2({
      language: 'zh-CN',
      theme: 'bootstrap',
      placeholder: "材质",
      minimumInputLength: 0,
    ...
    fields.find(".material-color").select2({
      language: 'zh-CN',
      theme: 'bootstrap',
      placeholder: "颜色",
      minimumInputLength: 0,
